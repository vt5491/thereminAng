...
angular.module('thereminAngApp')
  ...
  .factory('theremin',  function (monad) {
    ...
    //console.log('theremin.top_level: monad=', monad);
    ...
    factory.start = function () {
      ...
      // console.log('thermin.start: monad.doSomthing=', monad.doSomething());
    ...
    factory.stop = function () {
      ...
      //vtthis.leapController.removeListener('frame', this.leapController.listeners('frame')[0]);
      for(var i = 0; i < this.oscs.length; i++) {
